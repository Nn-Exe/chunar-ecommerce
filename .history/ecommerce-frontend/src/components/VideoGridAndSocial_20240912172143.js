    ...
    <div className="grid-container">
      ...
      <div className="images-grid">
        <div className="image-item">
          <img src="https://github.com/Nn-Exe/chunar-images/blob/master/200*200/grid1.jpg?raw=true" alt="Image 1" className="grid-image" />
        </div>
        <div className="image-item">
          <img src="https://github.com/Nn-Exe/chunar-images/blob/master/200*200/grid2.jpg?raw=true" alt="Image 2" className="grid-image" />
        </div>
        <div className="image-item">
          <img src="https://github.com/Nn-Exe/chunar-images/blob/master/200*200/grid3.jpg?raw=true" alt="Image 3" className="grid-image" />
        </div>
      </div>
