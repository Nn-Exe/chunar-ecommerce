...
const Faq = () => {
  ...
  return (
    <div className="faq-section">
      <h2>Frequently Asked Questions</h2> {/* Header is centered and separate */}
        ...
        <div className={`faq-item ${activeIndex === 0 ? 'active' : ''}`}>
          ...
          {activeIndex === 0 && (
            <div className="faq-answer">
              <p>Jubilee is a dropshipping marketplace that lets you build your own cosmetic and skincare line with minimal upfront costs...</p>
            </div>
          )}
        </div>
