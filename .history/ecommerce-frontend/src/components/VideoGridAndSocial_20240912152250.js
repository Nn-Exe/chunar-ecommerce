    ...
    <div className="grid-container">
      ...
      <div className="images-grid">
        <div className="image-item">
          <img src="image1.jpg" alt="Image 1" className="grid-image" />
        </div>
        <div className="image-item">
          <img src="image2.jpg" alt="Image 2" className="grid-image" />
        </div>
        <div className="image-item">
          <img src="image3.jpg" alt="Image 3" className="grid-image" />
        </div>
      </div>
