    ...
    <div className="grid-container">
      ...
      <div className="images-grid">
        <div className="image-item">
          <img src="https://via.placeholder.com/200?text=Image+1" alt="Image 1" className="grid-image" />
        </div>
        <div className="image-item">
          <img src="https://via.placeholder.com/200?text=Image+2" alt="Image 2" className="grid-image" />
        </div>
        <div className="image-item">
          <img src="https://via.placeholder.com/200?text=Image+3" alt="Image 3" className="grid-image" />
        </div>
      </div>
